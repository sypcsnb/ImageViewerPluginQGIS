...
SOURCES = \
	__init__.py \
	image_viewer.py image_viewer_dialog.py

PLUGINNAME = image_viewer

PY_FILES = \
	__init__.py \
	image_viewer.py image_viewer_dialog.py

UI_FILES = image_viewer_dialog_base.ui
...
QGISDIR=C:\Users\sayum\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
